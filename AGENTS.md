...
| -------------------------------------------- | ----------------------------------------------------- | ------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 충돌·권한 — "이거 고쳐도 돼?", 문서끼리 다름                 | SSOT §0                                               | `docs/harness/04-decision.md` §1 (DEC-1 · DEC-2)                                             | — (넓히지 않고 `NEEDS_HUMAN` 선언)                                                                                                                                       |
| 사람의 개입 — 승인·반려·`NEEDS_HUMAN`·완료 판정·merge      | `docs/harness/04-decision.md` 해당 절 (§1 규칙 DEC-* · §2 루프와의 경계 · §3 코멘트·LLM 리뷰) | SSOT §0 (소유권) · §5                                                                          | `docs/harness/03-loop.md` §1 (시도 카운트)                                                                                                                              |
...
| 루프·시도 횟수·세션 복구 — "몇 번까지 해?", "이어서 하려면?"  | `docs/harness/03-loop.md` 해당 절 (§1 규칙 · §3 기록 양식 · §4 복구 절차 · §5 PR·CI) | 해당 Issue의 코멘트 이력 (시도 횟수의 원본)                                                       | SSOT §4 (검증과의 경계) · `04-decision.md` (사람 판단의 뜻)                                                                                                                  |
